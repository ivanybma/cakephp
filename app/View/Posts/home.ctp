<?php 
echo $this->Html->css("grossstyle", null, array('inline' => false)); 
echo $this->Html->script("//ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js", array('inline' => false));
echo $this->Html->script(array("menu.hoverIntent","mfnc","menucontrol"), array('inline' => false));
?>
...
<a class="lgofc" id="acmnu" href="'.$maclnk.'">My Account</a></td>    <!---- button in a form need to be defined with type = "button", or else, it will trigger the submit() event--->
